...
const adminUserDetails = require("../models/userlogin.js").admin_user;
...
const loggedin = function (req, res, next) {
  ...
  loguser.find({ session_id: session_id }).then(async (data, error) => {
    ...
    const userData = await adminUserDetails.findOne(
      { _id: data[0].user_id },
      (err, userData) => {
        console.log("checkingg", err, userData);
      }
    );
...
router.get(
  "/manage_registered_member",
  loggedin,
  matchController.manage_registered_member
);
router.get(
  "/change_password/:admin_user_id",
  loggedin,
  matchController.change_password
);
router.get(
  "/change_password_user/:front_user",
  loggedin,
  matchController.change_password_user
);
...
router.get(
  "/edit_event_date/:event_date_id",
  loggedin,
  matchController.edit_event_date
);
router.get(
  "/edit_live_game/:live_game_id",
  loggedin,
  matchController.edit_live_game
);
//Ball Running
router.get(
  "/manage_ball_running/:match_id",
  loggedin,
...
router.get(
  "/delete_live_game/:live_game_id",
  loggedin,
  matchController.delete_live_game
);
router.get("/delete_date/:date_id", loggedin, matchController.delete_date);
router.get(
  "/delete_reg_user/:reg_id",
  loggedin,
  matchController.delete_reg_user
);
...
//Match_odds
router.get(
  "/match_odds_selection",
  loggedin,
  matchController.match_odds_selection
);
router.get(
  "/manage_match_odds/:match_id",
  loggedin,
  matchController.manage_match_odds
);
router.get(
  "/manage_match_odds_user/:match_id",
  loggedin,
  matchController.manage_match_odds_user
);
...
router.post(
  "/save_match_live_game",
  loggedin,
  matchController.save_match_live_game
);
router.post(
  "/save_create_matchodds",
  loggedin,
  matchController.save_create_matchodds
);
router.post(
  "/save_match_reg_user",
  loggedin,
  matchController.save_match_reg_user
);
//Post Edit
router.get("/edit_admin/:admin_id", loggedin, matchController.edit_admin);
router.post(
  "/edit_manage_admin/:admin_id",
  loggedin,
  matchController.edit_manage_admin
);
router.post(
  "/edit_manage_game/:game_id",
  loggedin,
  matchController.edit_manage_game
);
router.post(
  "/edit_manage_event/:event_id",
  loggedin,
  matchController.edit_manage_event
);
router.post(
  "/edit_manage_date/:event_date_id",
  loggedin,
  matchController.edit_manage_date
);
router.post(
  "/edit_manage_live_game/:live_game_id",
  loggedin,
  matchController.edit_manage_live_game
);
//
